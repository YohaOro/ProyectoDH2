            ...
            <div class="row text-center d-flex justify-content-center pt-4 mb-2">
                <div class="col-md-2 mb-3">
                    <h6 class="aria-controls ">
                        <a class="text-decoration-none y-textcolor" href="faq.php"> Preguntas Frecuentes</a>
                    </h6>
                </div>
                <div class="col-md-2 mb-3">
                    <h6 class="aria-controls">
                        <a class="text-decoration-none y-textcolor" href="productos.php">Productos</a>
                    </h6>
                </div>
                <div class="col-md-2 mb-3">
                    <h6 class="aria-controls">
                        <a class="text-decoration-none y-textcolor" href="contacto.php">Contactanos</a>
                    </h6>
                </div>   
            </div>
